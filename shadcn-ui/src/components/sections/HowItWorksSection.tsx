...
export default function HowItWorksSection() {
  return (
    <section className="py-24 bg-brand-light" aria-labelledby="how-it-works-title">
      <div className="container">
        <div className="text-center mb-16">
          <h2 id="how-it-works-title" className="text-3xl font-bold tracking-tight sm:text-4xl mb-4 text-primary">
            Así funciona CumpleFactura (simple y automático).
          </h2>
        </div>

        <ol className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" role="list">
          {steps.map((step, index) => (
            <li key={index} className="bg-background p-8 rounded-xl border shadow-sm relative overflow-hidden group hover:shadow-md transition-all">
              ...
              <div className="relative z-10">
                <div className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-primary text-white font-bold mb-4" aria-hidden="true">
                  {step.number}
                </div>
