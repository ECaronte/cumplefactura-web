      ...
      <div className="container flex flex-col items-center text-center">
        <div className="space-y-6 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-8 duration-700">
          <h1 className="text-4xl font-extrabold tracking-tight lg:text-6xl text-primary">
            Vende en WooCommerce. Nosotros facturamos automáticamente cumpliendo la ley.
          </h1>
          <p className="text-xl text-muted-foreground max-w-[800px] mx-auto">
            Factura electrónica certificada con Verifactu, MiFacturae y firma digital.
            <br className="hidden md:block" />
            Todo integrado en tu tienda WooCommerce. Sin complicaciones, sin errores, sin líos.
          </p>
          ...
          <p className="text-sm text-muted-foreground font-medium pt-2">
            100% compatible con la factura electrónica obligatoria en España (2025–2026).
          </p>
        </div>
