...
export default function Home() {
  ...
  return (
    <MainLayout>
        ...
        <div className="container">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <h2 id="para-quien-title" className="text-3xl font-bold tracking-tight mb-4 text-slate-900">
            ...
            <div className="flex-1 flex justify-center">
              <div className="relative w-full max-w-md aspect-video bg-white rounded-xl shadow-xl border border-slate-200 p-6 flex flex-col items-center justify-center" aria-hidden="true">
      ...
      <section className="py-12 bg-white border-b border-slate-100" aria-labelledby="trust-title">
        <div className="container">
          <div className="text-center mb-8">
            <h3 id="trust-title" className="text-lg font-semibold text-slate-500 uppercase tracking-wider">Confianza y tecnología profesional</h3>
          </div>
          <ul className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center opacity-70 grayscale hover:grayscale-0 transition-all duration-500" role="list">
            ...
            <li className="flex flex-col items-center gap-2">
              <ShoppingCart className="h-10 w-10 text-slate-600" aria-hidden="true" />
      ...
      <section className="py-20 bg-slate-900 text-white" aria-labelledby="security-title">
        <div className="container">
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="flex-1">
              ...
              <h2 id="security-title" className="text-3xl font-bold tracking-tight mb-4">
            ...
            <div className="flex-1 flex justify-center">
              <div className="relative w-full max-w-md aspect-square md:aspect-video bg-slate-800 rounded-xl border border-slate-700 p-8 flex flex-col items-center justify-center overflow-hidden">
                ...
                <ShieldCheck className="absolute -bottom-12 -right-12 h-64 w-64 text-slate-700/20 z-0" aria-hidden="true" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-slate-50 border-y border-slate-200" aria-labelledby="erp-title">
        <div className="container">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <h2 id="erp-title" className="text-3xl font-bold tracking-tight mb-4 text-slate-900">
